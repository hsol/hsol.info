  ...
  pillars: [
    {
      ...
      labelKo: "전략적 사고",
      blurb:
        "흩어진 부분을 하나의 시스템으로 연결합니다. 부서·채널·역할을 가로지르는 구조를 설계해 비즈니스가 확장 가능한 형태로 작동하게 만듭니다.",
    },
    {
      key: "customer",
      ...
      labelKo: "고객 중심 사고",
      blurb:
        "기능보다 경험을, 산출물보다 사용 맥락을 먼저 봅니다. 사내 제품도 결국 사람이 쓰는 도구라는 관점에서 설계해왔습니다.",
    },
    {
      key: "design",
      ...
      labelKo: "디자인적 사고",
      blurb:
        "엔지니어로 시작했지만 코드는 도구일 뿐입니다. 문제를 다시 정의하고, 작은 가설로 검증한 뒤, 합리적인 형태로 깎아냅니다.",
    },
  ],
  personas: [
    {
