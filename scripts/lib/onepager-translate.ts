...
- **시제를 그대로 옮겨라.** 한국어 과거형을 영어 현재형으로 올리지 마라("기획·개발·운영했고" -> "planned, built, and ran", not "operate"). 접은 제품을 운영 중으로 읽히게 하면 사실 오류다.
- **주어를 바꾸지 마라.** 한국어가 팀을 주어로 둔 성과는 영어에서도 팀이 주어다("팀장으로 이끈 팀 성과" -> "team outcomes I led"). 팀 성과를 1인칭 능동 동사 나열로 바꾸지 마라.
